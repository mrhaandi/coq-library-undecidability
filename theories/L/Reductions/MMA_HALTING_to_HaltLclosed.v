...
From Undecidability.MinskyMachines Require Import MMA Util.MMA_facts.
  ...
  - move=> v. split.
    + move=> m. rewrite HP. split.
      ...
      * move=> /eval_rt_steps_eval => /(_ _ (enc_init_spec _ _)).
        ...
        have [[[j w]]|] := sss_step_or_stuck (i, v) 1 P.
        ** move=> /[dup] Hvw /enc_run_spec /=.
           ...
           by apply: rt_step.
        ** move=> /[dup] /out_code_iff /enc_run_spec_out_code H.
           move=> /[dup] /out_code_iff H''.
